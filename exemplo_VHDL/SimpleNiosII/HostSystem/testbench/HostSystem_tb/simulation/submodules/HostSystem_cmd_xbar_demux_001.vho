...
--synthesis_resources = 
 ...
 ENTITY  HostSystem_cmd_xbar_demux_001 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
		 ...
		 src0_data	:	OUT  STD_LOGIC_VECTOR (84 DOWNTO 0);
		 ...
		 src1_data	:	OUT  STD_LOGIC_VECTOR (84 DOWNTO 0);
		 src1_endofpacket	:	OUT  STD_LOGIC;
		 src1_ready	:	IN  STD_LOGIC;
		 src1_startofpacket	:	OUT  STD_LOGIC;
		 src1_valid	:	OUT  STD_LOGIC
	 ); 
 END HostSystem_cmd_xbar_demux_001;

 ARCHITECTURE RTL OF HostSystem_cmd_xbar_demux_001 IS
 ...
 BEGIN
	...
	src0_channel <= ( "0" & "0");
	src0_data <= ( sink_data(84 DOWNTO 0));
	src0_endofpacket <= sink_endofpacket;
	src0_startofpacket <= sink_startofpacket;
	src0_valid <= (sink_valid(0) AND sink_channel(0));
	src1_channel <= ( "0" & "0");
	src1_data <= ( sink_data(84 DOWNTO 0));
 ...
 END RTL; --HostSystem_cmd_xbar_demux_001
