...
--synthesis_resources = 
 ...
 ENTITY  HostSystem_rsp_xbar_demux_001 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END HostSystem_rsp_xbar_demux_001;

 ARCHITECTURE RTL OF HostSystem_rsp_xbar_demux_001 IS
 ...
 END RTL; --HostSystem_rsp_xbar_demux_001
