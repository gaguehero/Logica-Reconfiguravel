...
--synthesis_resources = 
 ...
 ENTITY  HSys_cmd_xbar_demux IS 
	 ...
	 ( 
		 ...
		 src0_data	:	OUT  STD_LOGIC_VECTOR (83 DOWNTO 0);
 ...
 BEGIN
	...
	src0_channel <= ( "0" & "0");
	src0_data <= ( sink_data(83 DOWNTO 0));
	src0_endofpacket <= sink_endofpacket;
	src0_startofpacket <= sink_startofpacket;
	src0_valid <= (sink_valid(0) AND sink_channel(0));
	src1_channel <= ( "0" & "0");
	src1_data <= ( sink_data(83 DOWNTO 0));
