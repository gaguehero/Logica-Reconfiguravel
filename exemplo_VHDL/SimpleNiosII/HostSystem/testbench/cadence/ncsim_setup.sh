...
mkdir -p ./libraries/exemplo_0_avalon_slave_translator_avalon_universal_slave_0_agent_rsp_fifo/
mkdir -p ./libraries/memory_s1_translator_avalon_universal_slave_0_agent_rsp_fifo/
mkdir -p ./libraries/exemplo_0/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/HostSystem_exemplo_0_avalon_slave_translator_avalon_universal_slave_0_agent_rsp_fifo.vho" -work exemplo_0_avalon_slave_translator_avalon_universal_slave_0_agent_rsp_fifo -cdslib ./cds_libs/exemplo_0_avalon_slave_translator_avalon_universal_slave_0_agent_rsp_fifo.cds.lib
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/contador0.vhd"                                                                            -work exemplo_0                                                                 -cdslib ./cds_libs/exemplo_0.cds.lib                                                                
  ncvhdl -v93 "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/contador1.vhd"                                                                            -work exemplo_0                                                                 -cdslib ./cds_libs/exemplo_0.cds.lib                                                                
  ncvhdl -v93 "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/contador8bit.vhd"                                                                         -work exemplo_0                                                                 -cdslib ./cds_libs/exemplo_0.cds.lib                                                                
  ncvhdl -v93 "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/reg32.vhd"                                                                                -work exemplo_0                                                                 -cdslib ./cds_libs/exemplo_0.cds.lib                                                                
  ncvhdl -v93 "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/reg32_avalon_interface.vhd"                                                               -work exemplo_0                                                                 -cdslib ./cds_libs/exemplo_0.cds.lib                                                                
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/hostsystem_exemplo_0_avalon_slave_translator.vhd"                                         -work HostSystem_inst                                                           -cdslib ./cds_libs/HostSystem_inst.cds.lib                                                          
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/HostSystem_tb/simulation/submodules/hostsystem_exemplo_0_avalon_slave_translator_avalon_universal_slave_0_agent.vhd"          -work HostSystem_inst                                                           -cdslib ./cds_libs/HostSystem_inst.cds.lib                                                          
