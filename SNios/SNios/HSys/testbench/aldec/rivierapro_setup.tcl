...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/HSys_tb/simulation/submodules/aldec/altera_merlin_width_adapter.sv"                                                     -work width_adapter                                                                  
  vlog  "$QSYS_SIMDIR/HSys_tb/simulation/submodules/aldec/altera_merlin_address_alignment.sv"                                                 -work width_adapter                                                                  
  vlog  "$QSYS_SIMDIR/HSys_tb/simulation/submodules/aldec/altera_merlin_burst_uncompressor.sv"                                                -work width_adapter                                                                  
  ...
  vlog  "$QSYS_SIMDIR/HSys_tb/simulation/submodules/aldec/altera_reset_controller.v"                                                          -work rst_controller                                                                 
  vlog  "$QSYS_SIMDIR/HSys_tb/simulation/submodules/aldec/altera_reset_synchronizer.v"                                                        -work rst_controller                                                                 
  ...
  vcom  "$QSYS_SIMDIR/HSys_tb/simulation/submodules/HSys_top_avalon1_0_avalon_slave_0_translator_avalon_universal_slave_0_agent_rsp_fifo.vho" -work top_avalon1_0_avalon_slave_0_translator_avalon_universal_slave_0_agent_rsp_fifo
  ...
  vlog  "$QSYS_SIMDIR/HSys_tb/simulation/submodules/aldec/altera_merlin_slave_agent.sv"                                                       -work memory_s1_translator_avalon_universal_slave_0_agent                            
  vlog  "$QSYS_SIMDIR/HSys_tb/simulation/submodules/aldec/altera_merlin_burst_uncompressor.sv"                                                -work memory_s1_translator_avalon_universal_slave_0_agent                            
  vlog  "$QSYS_SIMDIR/HSys_tb/simulation/submodules/aldec/altera_merlin_master_agent.sv"                                                      -work cpu_instruction_master_translator_avalon_universal_master_0_agent              
  vlog  "$QSYS_SIMDIR/HSys_tb/simulation/submodules/aldec/altera_merlin_slave_translator.sv"                                                  -work memory_s1_translator                                                           
  vlog  "$QSYS_SIMDIR/HSys_tb/simulation/submodules/aldec/altera_merlin_master_translator.sv"                                                 -work cpu_instruction_master_translator                                              
  vcom  "$QSYS_SIMDIR/HSys_tb/simulation/submodules/bram.vhd"                                                                                 -work top_avalon1_0                                                                  
  vcom  "$QSYS_SIMDIR/HSys_tb/simulation/submodules/reg32.vhd"                                                                                -work top_avalon1_0                                                                  
  vcom  "$QSYS_SIMDIR/HSys_tb/simulation/submodules/top_avalon.vhd"                                                                           -work top_avalon1_0                                                                  
  ...
  vcom  "$QSYS_SIMDIR/HSys_tb/simulation/submodules/hsys_top_avalon1_0_avalon_slave_0_translator.vhd"                                         -work HSys_inst                                                                      
  ...
  vcom  "$QSYS_SIMDIR/HSys_tb/simulation/submodules/hsys_top_avalon1_0_avalon_slave_0_translator_avalon_universal_slave_0_agent.vhd"          -work HSys_inst                                                                      
